            ...
            <div class="max-w-3xl mx-auto">
                <article class="bg-white dark:bg-slate-800 shadow-sm sm:shadow-md sm:rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="p-6 md:p-10">
                        <div class="prose prose-slate dark:prose-invert max-w-none pb-10 md:pb-20 prose-p:text-slate-600 dark:prose-p:text-slate-300 prose-p:leading-relaxed prose-p:mb-0 text-lg md:text-xl font-serif"><?= $post['content'] ?></div>
                    </div>
                </article>

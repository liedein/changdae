...
<header id="main-header" class="fixed w-full top-0 z-[60] bg-[#FFD400] border-b-2 border-black transition-colors duration-300">
    <div class="max-w-[1800px] mx-auto px-6 h-20 md:h-24 flex justify-between items-center">
        ...
        <div class="flex md:hidden items-center space-x-3">
            ...
            <button id="mobile-menu-btn" class="p-2 border-2 border-black rounded-md text-black hover:bg-black hover:text-[#FFD400] transition-colors dark:border-[#FFD400] dark:text-[#FFD400] dark:hover:bg-[#FFD400] dark:hover:text-black">
...
<div id="mobile-menu" class="fixed inset-0 z-[100] hidden justify-end">
    ...
    <!-- Background Logo (Left Center) -->
    <img src="/assets/img/gosin_logo.png" alt="Gosin Logo" class="absolute left-4 top-1/2 -translate-y-1/2 w-[calc(25%-2rem)] object-contain opacity-80 z-40 pointer-events-none brightness-0 invert">
    ...
    <div class="relative w-3/4 h-full bg-slate-50 dark:bg-slate-900 shadow-2xl overflow-y-auto flex flex-col transition-transform duration-300">
        ...
        <div class="w-full space-y-8 pt-24 pb-10 px-6">
        <?php foreach ($menuItems as $key => $menu): ?>
            <div>
                <?php
                // 메뉴별 색상 설정
